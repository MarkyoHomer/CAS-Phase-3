  ...
  <ul>
    ...
    <li id="Integ-Arrow" class="toggle-btn" onclick="toggleSubmenu('IntSub')">
      ...
      <ul class="submenu" id="IntSub">
        <li id="IntegDtS"><a href="${R}pages/integrations/detailed-status.html"><i class="fas fa-list" style="color:rgb(10,186,10);font-size:14px"></i> Detailed Status</a></li>
        <li id="IntegExP"><a href="${R}pages/integrations/extraction-progress.html"><i class="fas fa-list" style="color:rgb(10,186,10);font-size:14px"></i> Extraction Progress</a></li>
      </ul>
    </li>
    ...
    <li id="Trnx-Arrow" class="toggle-btn" onclick="toggleSubmenu('TrnxSub')">
      ...
      <ul class="submenu" id="TrnxSub">
        ...
        <li id="BCAS"><a href="${R}pages/transactions/branch-cas.html"><i class="fas fa-hourglass-half" style="color:rgb(11,161,11);font-size:14px"></i> Branch CAS</a></li>
      </ul>
    </li>
    ...
    <li id="FT-Arrow" class="toggle-btn" onclick="toggleSubmenu('FTSub')">
      ...
      Fund Transfer<i style="position:absolute;right:10px;" class="fa-solid fa-angle-down"></i></a>
      <ul class="submenu" id="FTSub">
        <li><a href="${R}pages/fund-transfer/transaction-list.html"><i class="fas fa-list-check" style="color:rgb(10,186,10);font-size:14px"></i> Transaction List</a></li>
        <li><a href="${R}pages/fund-transfer/recon-report.html"><i class="fas fa-list-check" style="color:rgb(10,186,10);font-size:14px"></i> Recon Report</a></li>
      </ul>
    </li>
    ...
    <li id="Settle-Arrow" class="toggle-btn" onclick="toggleSubmenu('SettleSub')">
      <a href="#"><i class="fas fa-handshake" style="color:rgb(11,161,11);font-size:18px"></i>
    ...
    <li id="Reprt-Arrow" class="toggle-btn" onclick="toggleSubmenu('ReprtSub')">
      ...
      <ul class="submenu" id="ReprtSub">
        <li id="RprtASum"><a href="${R}pages/reporting/account-summary.html"><i class="fas fa-list-check" style="color:rgb(10,186,10);font-size:14px"></i> Account Summary</a></li>
        <li id="RprtDtlr" class="icon-text"><a href="${R}pages/reporting/detailed-ledger.html"><i class="fas fa-list-check" style="color:rgb(10,186,10);font-size:14px"></i></a><span>Detailed <br>Ledger Reports</span></li>
        <li id="RprtFinR"><a href="${R}pages/reporting/financial-reports.html"><i class="fas fa-list-check" style="color:rgb(10,186,10);font-size:14px"></i> Financial Reports</a></li>
        <li id="RprtAreaD"><a href="${R}pages/reporting/area-detailed-report.html"><i class="fas fa-list-check" style="color:rgb(10,186,10);font-size:14px"></i> Area Detailed Report</a></li>
        <li id="RprtBookA"><a href="${R}pages/reporting/book-of-accounts.html"><i class="fas fa-list-check" style="color:rgb(10,186,10);font-size:14px"></i> Book of Accounts</a></li>
      </ul>
    </li>
    ...
    <li id="Montr-Arrow" class="toggle-btn" onclick="toggleSubmenu('MontrSub')">
      ...
      <ul class="submenu" id="MontrSub">
        <li id="Mntr-Upld"><a href="${R}pages/monitoring/upload-monitoring.html"><i class="fas fa-magnifying-glass" style="color:rgb(10,186,10);font-size:14px"></i> Upload Monitoring</a></li>
        <li id="Mntr-Aud"><a href="${R}pages/monitoring/audit-trail.html"><i class="fas fa-magnifying-glass" style="color:rgb(10,186,10);font-size:14px"></i> Audit Trail</a></li>
      </ul>
    </li>
